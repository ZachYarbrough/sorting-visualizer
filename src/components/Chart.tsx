...
const Chart = ({ toggleCRTStyle }: any) => {
	...
	<div id="chart">
		...
		<div style={{ display: 'flex', justifyContent: 'space-between'}}>
			...
			<button style={{ backgroundColor: selectedSort === SORT_TYPE.BUBBLE_SORT ? '#383639' : '', color: 'white', marginRight: '0.5rem' }} onClick={() => SelectSortType(SORT_TYPE.BUBBLE_SORT)}>Bubble Sort</button>
			<button style={{ backgroundColor: selectedSort === SORT_TYPE.INSERTION_SORT ? '#383639' : '', color: 'white', marginRight: '0.5rem' }} onClick={() => SelectSortType(SORT_TYPE.INSERTION_SORT)}>Insertion Sort</button>
			<button style={{ backgroundColor: selectedSort === SORT_TYPE.SELECTION_SORT ? '#383639' : '', color: 'white', marginRight: '0.5rem' }} onClick={() => SelectSortType(SORT_TYPE.SELECTION_SORT)}>Selection Sort</button>
			<button style={{ backgroundColor: selectedSort === SORT_TYPE.QUICK_SORT ? '#383639' : '', color: 'white', marginRight: '0.5rem' }} onClick={() => SelectSortType(SORT_TYPE.QUICK_SORT)}>Quick Sort</button>
			<button style={{ backgroundColor: selectedSort === SORT_TYPE.MERGE_SORT ? '#383639' : '', color: 'white', marginRight: '0.5rem' }} onClick={() => SelectSortType(SORT_TYPE.MERGE_SORT)}>Merge Sort</button>
		    </div>
		    <button className='sm-display-none' style={{ marginRight: '0.5rem', width: '13rem' }} onClick={() => toggleCRTStyle()}>Toggle CRT Filter</button>
		    <button className='sm-display-none' style={{ marginRight: '0.5rem', width: '5rem' }} onClick={() => SortChartData(selectedSort)}><ReplayIcon /></button>
		</div>
		...
		<div className="sm-display" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', width: '100%' }}>
		    ...
		    <button
			style={{
			    backgroundColor: selectedSort === SORT_TYPE.BUBBLE_SORT ? '#383639' : '',
			    color: 'white',
			    width: '100%'
			}}
		    ...
		    <button
			style={{
			    backgroundColor: selectedSort === SORT_TYPE.INSERTION_SORT ? '#383639' : '',
			    color: 'white',
			    width: '100%'
			}}
		    ...
		    <button
			style={{
			    backgroundColor: selectedSort === SORT_TYPE.SELECTION_SORT ? '#383639' : '',
			    color: 'white',
			    width: '100%'
			}}
		    ...
		    <button
			style={{
			    backgroundColor: selectedSort === SORT_TYPE.QUICK_SORT ? '#383639' : '',
			    color: 'white',
			    width: 'ou00%'
			}}
		    ...
		    <button
			style={{
			    backgroundColor: selectedSort === SORT_TYPE.MERGE_SORT ? '#383639' : '',
			    color: 'white',
			    width: '100%'
			}}
		    ...
		    <button className='sm-display' style={{ marginRight: '0.5rem', width: '100%' }} onClick={() => SortChartData(selectedSort)}>Replay Visualization</button>
		</div>
		...
		<div style={{ marginTop: '1rem', display: 'flex', justifyContent: 'space-between', height: '22rem' }}>
		...
		<div className='sm-display-none' style={{ display: 'flex', width: '100%', justifyContent: 'space-between', alignItems: 'center', marginTop: '1rem' }}>
		    <div>
			...
			<input
			    ...
			    style={{ transform: 'rotateY(180deg)', margin: '0 0.5rem', width: '25rem' }}
			/>
			Fast	    
		    </label>
		</div>
		...
		<div className="sm-display" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', width: '100%', marginTop: '1rem', alignItems: 'center' }}>
			...
			<input
			    ...
			    value={speed}
			    onChange={(e) => setSpeed(Number(e.target.value))}
			    style={{ transform: 'rotateY(180deg)', flex: '1', width: '100%' }}
			/>
			Fast
		    </label>
		</div>
